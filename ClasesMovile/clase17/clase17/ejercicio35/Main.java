...
public class Main {
	...
	public static void main(String[] args) {
		...
		JefeZonaNorte = new JefeZona("Mauro Scolapio", 4, 60000, "Peugeot 308, Patente AA234");
		JefeZonaSur = new JefeZona("Hugo Prado", 3, 55000, "Citroen c4, Patente AB234");
		Vendedor1 = new Vendedor("Miguel Angel Zorzoni", 10, 30000, null, "Automovil", "FHK 311", "Fiat", "Palio",
				1559364444, "Ventas-Zona Norte", 5.0);
		Vendedor2 = new Vendedor("Maximo Sarago", 5, 25000, null, "Camioneta", "BOT 831", "Renaul", "Kangoo",
				1559365555, "Ventas-Zona Sur", 5.0);
		Secretario1 = new Secretario("Rodrigo Ruiz", 5, 25000, null, 1146385026, "Oficina N° 5");
		Secretario2 = new Secretario("Mario Jerez", 2, 25000, null, 1146385027, "Oficina N° 9");
