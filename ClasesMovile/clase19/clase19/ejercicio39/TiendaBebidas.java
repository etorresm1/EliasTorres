package clase19.ejercicio39;

import java.util.ArrayList;
import java.util.Scanner;

import clase17.ejercicio34.Tienda;
...
public class TiendaBebidas {
	...
	public static void menuEntrada(ArrayList<Tienda> productos) {
		...
		do {
			System.out.println("+++ Botilleria \" Chinaski \" +++");
			System.out.println("");
			...
			case 3: {
				System.out.println("Gracias!!! por comprar en Botillerias Chinaski");
				break;
			}
			default: {
	...
	public static void menuVentas(ArrayList<Tienda> productos) {
		...
		do {
			...
			for (int i = 0; i < productos.size(); i++) {
				System.out.println("Pusle " + i + " Para comprar " + productos.get(i).devolverNombre()
						+ " cuyo precio es de " + productos.get(i).devolverPrecio() + " y el stock es de "
						+ productos.get(i).devolverStok() + " unidades");
			}
